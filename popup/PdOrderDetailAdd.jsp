...
<head>
<title>ĐƠN HÀNG &gt; THÊM THÔNG TIN &gt; CÔNG TY TNHH HONG WON VINA (ORDER &gt; DETAIL ADD &gt; HONG WON VINA co.,LTD)</title>
...
function widthName(widpos, width){
	...
	else if(widpos==34){$('#w34').val(width);}
	else{$('#w35').val(width);}
}
...
function detailSave(){
	...
	if($('#orderQty').val()==''){
		...
		var ajaxUrl = "<c:url value='/pd/order/saveOrderDetailInfo.do'/>";
	...
	if($('#orderQty').val()==''){
		...
		f.action="<c:url value='/pd/order/saveOrderDetailInfo.do'/>";
		f.submit();
	}	
	*/
}
...
<div id="layerWrap">
	<div class="layerPop layerPop_down" id="inbox">
		<div class="layerTop">
			<strong>THÊM THÔNG TIN ĐƠN HÀNG (ADD ORDER DETAIL)</strong>
						...
						<table summary="사원코드, 사원명, 부서, 근무조, 출결 등 입력" class="table_popup">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" class="w98p" name="s1" id="s1" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s1t" id="s1t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s2" id="s2" onkeypress="return isNumberKey(event)"></td>									
									<td><input type="text" class="w98p" name="s2t" id="s2t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s3" id="s3" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s3t" id="s3t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s4" id="s4" onkeypress="return isNumberKey(event)"></td>
								</tr>
								...
								<tr>
									<th scope="row" title='QTY(pairs)' >SỐ LƯỢNG (đôi)</th>
									<td><input type="text" class="w98p" name="s4t" id="s4t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s5" id="s5" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s5t" id="s5t" onkeypress="return isNumberKey(event)"></td>									
									<td><input type="text" class="w98p" name="s6" id="s6" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s6t" id="s6t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s7" id="s7" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s7t" id="s7t" onkeypress="return isNumberKey(event)"></td>
								</tr>
								...
								<tr>
									<th scope="row" title='QTY(pairs)' >SỐ LƯỢNG (đôi)</th>
									<td><input type="text" class="w98p" name="s8" id="s8" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s8t" id="s8t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s9" id="s9" onkeypress="return isNumberKey(event)"></td>									
									<td><input type="text" class="w98p" name="s9t" id="s9t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s10" id="s10" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s10t" id="s10t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s11" id="s11" onkeypress="return isNumberKey(event)"></td>
								</tr>
								...
								<tr>
									<th scope="row" title='QTY(pairs)' >SỐ LƯỢNG (đôi)</th>
									<td><input type="text" class="w98p" name="s11t" id="s11t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s12" id="s12" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s12t" id="s12t" onkeypress="return isNumberKey(event)"></td>									
									<td><input type="text" class="w98p" name="s13" id="s13" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s13t" id="s13t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s14" id="s14" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s14t" id="s14t" onkeypress="return isNumberKey(event)"></td>
								</tr>
								...
								<tr>
									<th scope="row" title='QTY(pairs)' >SỐ LƯỢNG (đôi)</th>
									<td><input type="text" class="w98p" name="s15" id="s15" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s15t" id="s15t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s16" id="s16" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s16t" id="s16t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s17" id="s17" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s17t" id="s17t" onkeypress="return isNumberKey(event)"></td>
									<td><input type="text" class="w98p" name="s18" id="s18" onkeypress="return isNumberKey(event)"></td>								
								</tr>
